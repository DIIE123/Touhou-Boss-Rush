...
//Date: June 14, 2024
//Description: Class to hold crystal bullet information
...
public class CrystalBullet extends Bullet {
	...
	// Return: ---
	public CrystalBullet(String color, double xPos, double yPos, double speed, double angle) {
		super(color, 112, xPos, yPos, speed, angle);
	...
	// Return: ---
	public CrystalBullet(String color, double xPos, double yPos, double speed, double angle, double acceleration) {
